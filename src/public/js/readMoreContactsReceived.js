$(document).ready(function() {
    $("#link-read-more-contacts-received").bind("click", function() {
        ...
        $.get(`/contact/read-more-contacts-reveived?skipNumber=${skipNumber}`, function(newContactUser) {
            if (!newContactUser.length) {
                alertify.notify("Bạn không còn yêu cầu kết bạn nào để xem nữa cả.", "error", 7);
