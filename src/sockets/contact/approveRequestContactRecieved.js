    ...
    io.on("connection", (socket) => {
        ...
        socket.on("approve-request-contact-recieved", (data) => {
            ...
            if (clients[data.contactId]) {
                emitNotyfyToArray(clients, data.contactId, io, "response-approve-request-contact-recieved", currentUser);
            }
        });
...
module.exports = approveRequestContactRecieved;
