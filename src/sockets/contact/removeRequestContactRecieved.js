 ...
 */
let removeRequestContactRecieved = io => {
    let clients = {};
    ...
    io.on("connection", socket => {
        ...
        socket.on("remove-request-contact-recieved", data => {
            // console.log(data);
            ...
            if (clients[data.contactId]) {
                emitNotyfyToArray(clients, data.contactId, io, "response-remove-request-contact-recieved", currentUser);
            }
        });
...
module.exports = removeRequestContactRecieved;
