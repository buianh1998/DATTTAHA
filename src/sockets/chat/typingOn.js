        ...
        socket.on("user-is-typing", (data) => {
            if (data.groupId) {
                ...
                if (clients[data.groupId]) {
                    emitNotyfyToArray(clients, data.groupId, io, "response-user-is-typing", response);
                }
            }
            if (data.contactId) {
                let response = {
                ...
                if (clients[data.contactId]) {
                    emitNotyfyToArray(clients, data.contactId, io, "response-user-is-typing", response);
                }
            }
        });
