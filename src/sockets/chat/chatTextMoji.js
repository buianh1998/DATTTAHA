        ...
        socket.on("chat-text-emoji", (data) => {
            if (data.groupId) {
                ...
                if (clients[data.groupId]) {
                    emitNotyfyToArray(clients, data.groupId, io, "response-chat-text-emoji", response);
                }
            }
            if (data.contactId) {
                let response = {
                ...
                if (clients[data.contactId]) {
                    emitNotyfyToArray(clients, data.contactId, io, "response-chat-text-emoji", response);
                }
            }
        });
